...
from .quantile_dqn_agent import QuantileDQNAgent
...
def create_agent(
    ...
    if agent_type in {"quantile_dqn", "rainbow"}:
        return QuantileDQNAgent(obs_dim, action_dim, config.memory, config.ppo, device, agent_config)
